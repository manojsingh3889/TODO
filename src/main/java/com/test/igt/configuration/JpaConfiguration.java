package com.test.igt.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.test.igt.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.test.igt.model" });
